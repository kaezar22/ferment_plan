...
- El Google Sheet ya compartido con el email de esa cuenta de servicio
  ...
  Esto ya está hecho para el Sheet:
  `https://docs.google.com/spreadsheets/d/160F053a-MKrFQAet7MA28FDU6i5cJCiucM6-9XYiZ_M/edit`
...
4. Crea una nueva, ponle un nombre como "Ferment Plan", y copia el código
   de 16 caracteres que te da (algo como `abcd efgh ijkl mnop`). Esa es tu
   `GMAIL_APP_PASSWORD` — **no es tu contraseña normal de Gmail**.
...
#  - tu Gmail y la contraseña de aplicación dentro de [gmail] (opcional,
#    solo si quieres probar el botón "Enviar alerta de prueba")
...
3. En **Settings -> Secrets** de la app en Streamlit Cloud, pega el mismo
   ...
   valores reales, incluyendo `[gmail]` si quieres usar el botón de
   correo de prueba desde la app).
